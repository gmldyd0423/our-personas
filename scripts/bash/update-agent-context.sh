...
CURSOR_FILE="$REPO_ROOT/.cursor/rules/personas-rules.mdc"
QWEN_FILE="$REPO_ROOT/QWEN.md"
AGENTS_FILE="$REPO_ROOT/AGENTS.md"
WINDSURF_FILE="$REPO_ROOT/.windsurf/rules/personas-rules.md"
KILOCODE_FILE="$REPO_ROOT/.kilocode/rules/personas-rules.md"
AUGGIE_FILE="$REPO_ROOT/.augment/rules/personas-rules.md"
ROO_FILE="$REPO_ROOT/.roo/rules/personas-rules.md"
CODEBUDDY_FILE="$REPO_ROOT/CODEBUDDY.md"
AMP_FILE="$REPO_ROOT/AGENTS.md"
Q_FILE="$REPO_ROOT/AGENTS.md"

# Template file
TEMPLATE_FILE="$REPO_ROOT/.personas/templates/agent-file-template.md"
