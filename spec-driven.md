...
/personas.specify Real-time chat system with message history and user presence
...
/personas.plan WebSocket for real-time messaging, PostgreSQL for history, Redis for presence
...
2. **Don't guess**: If the prompt doesn't personas something, mark it
```
