...
2. **Load company guidelines** (if they exist):
   - Read `/d-docs/company/testing/testing-guidelines.md` if it exists
   - Apply company-wide testing guidelines when designing E2E tests
...
7. /personas.design-test   → Generate E2E test scenario (YOU ARE HERE)
